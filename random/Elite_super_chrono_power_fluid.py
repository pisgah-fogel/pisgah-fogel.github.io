...
def trackpoint_to_dic(trackpoint):
    dic = {}
    dic["Time"] = trackpoint.getElementsByTagName('Time')[0].firstChild.data
    dic["HeartRate"] = trackpoint.getElementsByTagName('HeartRateBpm')[0].childNodes[1].firstChild.data
    dic["DistanceMeters"] = trackpoint.getElementsByTagName('DistanceMeters')[0].firstChild.data
    dic["Speed"] = trackpoint.getElementsByTagName('ns3:Speed')[0].firstChild.data
    dic["Cadence"] = trackpoint.getElementsByTagName('Cadence')[0].firstChild.data
    return dic
